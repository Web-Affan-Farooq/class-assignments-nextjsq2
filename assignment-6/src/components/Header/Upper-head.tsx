...
const Upper_head = () => {
  return (
    <div className="flex flex-row flex-wrap justify-between align-middle items-center px-6 py-3 border-b-2 border-solid border-black max-md:flex-col max-md:text-center">
